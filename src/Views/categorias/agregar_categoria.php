<section class="flex items-center justify-center min-h-screen bg-gray-100 py-8">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-cyan-500 to-teal-400 p-6">
            ...
            <p class="text-white/90">Registra una nueva categoría para objetos perdidos</p>
        </div>
        ...
        <form class="p-6 space-y-6" action="/agregar_categoria/crear" method="post">
            <!-- Único campo necesario -->
